...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "tushar.24550@sscbs.du.ac.in" },
    { icon: Phone, label: "Phone", value: "+91 8800393255" },
    { icon: MapPin, label: "Location", value: "Delhi, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/TUSHAR24550" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/tushar720614325/" },
    { icon: Mail, url: "tushar.24550@sscbs.du.ac.in" },
    { icon: MessageCircle, url: "https://wa.me/+918800393255" },
    { icon: Instagram, url: "https://www.instagram.com/tushar_bandhu/" },
  ];
