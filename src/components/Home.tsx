...
export function Home({ theme }: HeroProps) {
  ...
  const connectLinks = [
    { img: linkedinLogo, link: "https://www.linkedin.com/in/tushar720614325/" },
    { img: gmailLogo, link: "mailto:tushar.24550@sscbs.du.ac.in" },
    { img: whatsappLogo, link: "https://wa.me/+918800393255" },
    { img: instagramLogo, link: "https://www.instagram.com/tushar_bandhu/" },
    
  ];

  const workLinks = [
    { img: githubLogo, link: "https://github.com/TUSHAR24550" },
    
  ];

  const [typedRoles, setTypedRoles] = useState("");
  const rolesText = "AI Enthusiast | Full Stack Developer | Future Tech Builder";
    ...
    <section id="home" className="hero">
      ...
      <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
        <motion.h1 className="hero-name" variants={itemVariants}>
          Hi! I’m <br />
          <span className="gradient-text hero-name-line">TUSHAR</span>
        ...
        <motion.div className="hero-info" variants={itemVariants}>
          {[
            ...
            { label: "💼 Expertise", value: "Web development" },
            { label: "📞 Contact", value: "tushar.24550@sscbs.du.ac.in" },
          ].map((info, i) => (
