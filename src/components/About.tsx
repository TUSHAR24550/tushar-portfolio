        ...
        <div className="about-sticky">
          ...
          >
            <div className="info-inner">
              ...
              <p>
                I’m Tushar, a passionate Full Stack Developer and Computer Science student focused on building real-world solutions.
I enjoy exploring AI, machine learning, computer vision, and modern web development through hands-on projects.
I’m eager to apply my skills, solve challenges, and grow in a professional environment.


              </p>

              <p>
               Beyond code, I enjoy design, motion, and creative problem-solving. I also have an interest in marketing and digital strategy, combining technology with user engagement. My goal is to build solutions that perform, inspire, and create impact.
              </p>

              <p>
               3rd-year B.Sc Computer Science student with hands-on experience in Full Stack Development, AI, Machine Learning, and Computer Vision projects.
Proficient in Python, Django, TensorFlow, and modern web technologies. Passionate about building intelligent real-world solutions and seeking opportunities to grow through impactful projects.
      ...
      <div className={`about-hobbies ${hobbiesVisible ? "hobbies-show" : "hobbies-hidden"}`}>
        ...
        <div className="hobby-grid">
          ...
          <div className="hobby"> 🎨Drawing</div>
           <div className="hobby"> 📸Cinematography </div>
          <div className="hobby"> 🧾Writing</div>
          <div className="hobby"> Content Creation</div>
          <div className="hobby"> Marketing </div>
        </div>
      </div>
    </section>
  );
