...
export function Blog() {
  const blogPosts = [
    {
      title: 'Building Mind Replica',
      excerpt: 'Creating an AI twin that learns personality and memories has shown me how technology can become deeply personal. I enjoy building intelligent systems that feel meaningful and human.',
      image: './blog1.jpg',
      date: 'Feb 20, 2026',
      readTime: '5 min read',
    },
    {
      title: 'A wish',
      excerpt: 'Lost between silence and storms, yet still learning how to shine through the cracks',
      image: './blog2.avif',
      date: 'April 15, 2025',
      readTime: '2 min read',
    },
